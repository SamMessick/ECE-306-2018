...
//=========================================================================
  // Configure Port 2
  // P2_0
  P2SEL0 &= ~BCLUART_TXD;                // Set to GP I/O
  P2SEL1 |=  BCLUART_TXD;                // Set to GP I/O
  P2OUT  &= ~BCLUART_TXD;                // Set out value Low [off]
  P2DIR  |= BCLUART_TXD;                 // Set direction to output
  // P2_1
  P2SEL0 &= ~BCLUART_RXD;                // Set to GP I/O
  P2SEL1 |=  BCLUART_RXD;                // Set to GP I/O
  ...
  // P2_3
  P2SEL0 &= ~P2_3;                       // Set to GP I/O
  P2SEL1 &= ~P2_3;                       // Set to GP I/O
  P2OUT  &= ~P2_3;                       // Set out value Low [off]
  P2DIR  |= P2_3;                        // Set direction to output
  // P2_4
  P2SEL0 &= ~P2_4;                       // Set to GP I/O
  P2SEL1 &= ~P2_4;                       // Set to GP I/O
  P2OUT  &= ~P2_4;                       // Set out value Low [on]
  P2DIR  |= P2_4;                        // Set direction to output
  // P2_5
  P2SEL0 &= ~J4_34;                      // Set to GP I/O
  P2SEL1 &= ~J4_34;                      // Set to GP I/O
  P2OUT  &= ~J4_34;                      // Set out value Low [off]
  P2DIR  |= J4_34;                       // Set direction to output
  // P2_6
  P2SEL0 &= ~J4_35;                      // Set to GP I/O
  P2SEL1 &= ~J4_35;                      // Set to GP I/O
  P2OUT  &= ~J4_35;                      // Set out value Low [off]
  P2DIR  |= J4_35;                       // Set direction to output
  // P2_7
  P2SEL0 &= ~P2_7;                       // Set to GP I/O
  P2SEL1 &= ~P2_7;                       // Set to GP I/O
  P2OUT  &= ~P2_7;                       // Set out value Low [off]
  P2DIR  |= P2_7;                        // Set direction to output
}
////////////////////////////////////////////////////////////////////////
...
//=========================================================================
  ...
  P5IE   |= BUTTON2;                    // Enable interrupts for Button 2
  P5IES  |= BUTTON2;                    // Interrupts occur on Hi/Lo edge (press)
  ...
  P5IE   |= BUTTON1;                    // Enable interrupts for Button 1
