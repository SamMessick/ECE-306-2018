/* pc_server.cpp
 *
 * Server for handling Xbox 360 Controller input,
 * sending commands to the SPWF01SA11 WiFi module
 * over port 8888
 *
 * This project was created for ECE 306 at NCSU
 * and was built for use on Windows computers
 *
 * Author: Sam Messick
...
int main()
{
	Gamepad gamepad;         // Connected controller
	bool wasConnected = true; // Defines if last state update was from connected controller
